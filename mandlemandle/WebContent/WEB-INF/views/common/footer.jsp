        ...
        <div class="footArea">
            <div class="info">
                <ul class="infoList">
                    ...
                    <li>
                        <ul class="l1">
                            <li><a href="/board.bo?boardDivide=40">맨들맨들 소개</a></li>
                            <li><a href="/board.bo?boardDivide=50">이용방법</a></li>
                            <li><a href="/board.bo?boardDivide=60">고객센터</a></li>
                            <li><a href="/board.bo?boardDivide=70">커뮤니티</a></li>
                            <li><a href="/board.bo?boardDivide=10">공지사항</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
